    ...
    <Stack className="filter-main">
      ...
      <Stack className="find-your-home" mb="30px">
        ...
        <Stack className="square-year-input">
          <FormControl>
            <InputLabel id="min-select">Min</InputLabel>
            <Select labelId="min-select" value={0} label="Min">
          ...
          <FormControl>
            <InputLabel id="max-select">Max</InputLabel>
            <Select labelId="max-select" value={500} label="Max">
              {propertySquare.map((square: number) => (
                <MenuItem value={square} key={square}>
                  {square}
                </MenuItem>
